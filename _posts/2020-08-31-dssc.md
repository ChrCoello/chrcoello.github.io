...
The data-driven clustering allows to have an additional degree of freedom, the number of clusters *K*.  This is essential to study more in detail how reducing the number of forecasting models influence the forecasting. Very early, the tradeoff (*Figure 3*) between number of models and accuracy was identified by thinking about the extreme cases:  
