...
Key ideas: 
 ...
 - z-transform, 
 - weekly average, 
 - labels per nettstatjon -> methodology
...
The case 1 will give an idea about how well the features predict the load, whereas case 2 to 4 are thought to show the degradation of the accuracy metric. We hypothesized that the accuracy metric (we choose *MAPE*, mean percentage absolute error) is going to degrade as follows:
$$
...
| Facebook Prohet            | {{fb_house1_MAPE_mean}}  \  {{fb_house1_MAPE_std}} | {{fb_house2_MAPE_mean}} \ {{fb_house2_MAPE_std}} |  {{fb_cabin1_MAPE_mean}} \ {{fb_cabin1_MAPE_std}}| {{fb_cabin2_MAPE_mean}} \ {{fb_cabin2_MAPE_std}}| {{fb_industry1_MAPE_mean}} \ {{fb_industry1_MAPE_std}} | {{fb_industry2_MAPE_mean}} \ {{fb_industry2_MAPE_std}} | 
