...
<figcaption>Table 2. Forecasting results obtained with four different models. The mean (and std) reported in the table are the mean (and std) over the 15 forecasts horizon. Each forecast horizon predicts 67 hours in the future.</figcaption>
